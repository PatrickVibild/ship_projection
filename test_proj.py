...
def transform_angle_continuous(original_angle):
...
if __name__ == '__main__':
    ...
    # Example usage
    input_angles = [15]  # Test including your specific example
    transformed_angles = [transform_angle_continuous(angle) for angle in input_angles]

    print("Transformed Angles:", transformed_angles)
